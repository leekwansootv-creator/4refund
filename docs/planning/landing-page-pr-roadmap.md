...
- 상담 전화·회사 대표전화·팩스·이메일이 목적별 연락처 상수를 사용하는가
...
| PR 5 | 병합 (#7)     | 통과            | 전문가 강점 비교       | `24799ac` |
| PR 6 | 병합 (#8)     | 통과            | 절차·문의·푸터 비교    | `d57d219` |
| PR 7 | 병합 (#9)     | 통과            | 4개 viewport 비교      | `8638553` |
| PR 8 | 병합 (#10)    | 통과            | 5개 상태 비교          | `6967ae6` |
| 추가 | 검토 중 (#11) | 통과            | 댓글 동작·3개 viewport | 해당 없음 |
