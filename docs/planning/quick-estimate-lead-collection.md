...
> 2026-09-04 후속 기획: [간편 환급액 선조회 및 상세 견적 신청 플로우](quick-estimate-result-first-flow.md)에 업종·직원 수 → 예상액 → 선택적 상세 견적 신청 변경안을 정리했다. 아직 구현 전이며, 이 문서의 연락처 우선 흐름은 변경 전 기준이다.
