...
2026-09-04 승인된 계약은 이관수 소유 계정과 기존 편집자 3명의 Spreadsheet 접근을 유지하는 것이다. 상담 원본 열람을 포함하며 [운영 runbook](../operations/quick-estimate-runbook.md#2026-09-04-접근-기준-승인)에 승인 경위를 기록한다. 새 상담 담당자 추가나 권한 확대는 다음 조건을 다시 승인한 뒤에만 허용한다.
...
당시 초기 운영은 이관수 소유 계정 한 명으로 제한했다. 이후 2026-09-04 기존 편집자 접근 유지 승인은 위의 현재 권한 기준을 따른다. 상담 기본 배정은 이관수를 유지하며 접근 유지 승인이 자동 배정 규칙 변경을 뜻하지 않는다.
