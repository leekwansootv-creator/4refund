...
export function CenterIntroductionSection() {
  ...
  return (
    <section
      ...
      className="relative h-[1132px] overflow-hidden bg-[#f1f2f5]"
    >
      ...
      <div className="relative z-10 flex h-full flex-col items-center gap-[100px] py-[100px]">
        <div className="w-full max-w-[var(--content-max-width)] px-[var(--content-inline-padding)]">
          <h2
            id="center-introduction-heading"
            className="text-[64px] leading-[1.3] font-bold text-[var(--color-brand-navy)]"
          >
            {centerIntroduction.heading}
          </h2>
          <p className="mt-2.5 text-xl leading-[1.2] text-[#486db2]">
            {centerIntroduction.description}
          </p>
        </div>

        <div className="w-full max-w-[var(--content-max-width)] overflow-hidden rounded-3xl bg-white shadow-[0_0_10px_rgba(163,189,210,0.25)]">
          <div className="p-[45px]">
            <div className="flex flex-col items-start gap-6">
              <h3 className="text-2xl leading-[1.2] font-bold text-[#0e163d]">
                {centerIntroduction.membersHeading}
              </h3>
              <ul className="flex w-full items-start justify-between px-[45px]">
                {centerIntroduction.members.map((member) => (
                  <li
                    key={member.name}
                    className="flex w-[139px] flex-col items-center gap-4 text-center"
                  >
                    {member.role === null ? (
                      <div className="flex size-[139px] items-center justify-center rounded-full border border-[#d8dee6] bg-[#f2f6fb]">
                    ...
                    <p className="w-full text-xl leading-[1.2] text-[#101010]">
          ...
          <div className="grid h-[393px] grid-cols-[515px_1fr] bg-[#f9fbfe] pt-[45px]">
            <div className="relative h-[348px] w-[515px]">
              <h3 className="absolute top-0 left-[45px] z-10 text-2xl leading-[1.2] font-bold text-[#0e163d]">
            ...
            <div className="flex flex-col items-start gap-6 pb-10 pl-[21px]">
              <p className="text-4xl leading-[1.2] font-bold text-[#101010]">
                {centerIntroduction.directorName}
              </p>
              <ul className="grid h-[190px] w-full grid-flow-col grid-cols-2 grid-rows-4 gap-x-8 gap-y-2.5">
                {centerIntroduction.directorCredentials.map((credential) => (
                  <li key={credential} className="flex items-center gap-4">
                    ...
                    />
                    <span className="text-xl leading-[2] font-medium text-[#101010]">
                      {credential}
                    </span>
                  </li>
                ))}
