...
| ------- | --------- | -------------------------------------------------------------- | ---------- | ----------------------------------- |
| PR 1    | 리뷰 대기 | [#22](https://github.com/leekwansootv-creator/4refund/pull/22) | 미확인     | Draft PR 출하                       |
| PR 2    | 계획      | 미생성                                                         | 미확인     | `QD-010` 승인 계정 권한 확인 필요   |
| PR 3    | 계획      | 미생성                                                         | 미확인     | 금액·입력 정책 승인 필요            |
| PR 4    | 계획      | 미생성                                                         | 미확인     | PR 2 채택과 개인정보 정책 승인 필요 |
