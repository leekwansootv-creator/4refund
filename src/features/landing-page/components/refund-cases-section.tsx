...
export function RefundCasesSection() {
  ...
  return (
    <section aria-labelledby="refund-cases-heading" className="flex h-[859px] flex-col py-[140px]">
      <div className="mx-auto w-full max-w-[var(--content-max-width)] px-[var(--content-inline-padding)]">
        <div className="flex flex-col items-center gap-3 text-center leading-[1.2]">
          <h2 id="refund-cases-heading" className="text-5xl leading-[1.2] font-bold text-black">
            {refundCases.heading}
          </h2>
          <p className="text-xl leading-[1.2] text-black">{refundCases.description}</p>
        </div>
      </div>
        ...
        <ul className="flex w-max gap-6 px-6">
          {refundCases.items.map((refundCase) => (
            <li
              ...
              className="relative flex h-[416px] w-[646px] shrink-0 items-center justify-center overflow-hidden rounded-3xl text-center text-white"
            >
              <Image
              ...
              <div className="relative flex flex-col items-center gap-[18px]">
                <div className="flex flex-col items-center gap-1 leading-[1.2]">
                  <h3 className="text-[32px] font-bold whitespace-nowrap">{refundCase.industry}</h3>
                  <p className="w-[113px] text-2xl">{refundCase.company}</p>
                </div>
                <div
                  className={`flex items-center justify-center gap-3 rounded-[100px] border border-white/50 px-6 py-[15px] backdrop-blur-[26px] ${styles.refundCapsule}`}
                >
                  <span className="rounded-[130px] bg-black/40 px-5 py-2.5 text-xl leading-[1.2] font-bold whitespace-nowrap">
                    환급 총액
                  </span>
                  <strong className="text-[28px] leading-[1.2] font-bold whitespace-nowrap">
                    {refundCase.amount}
                  </strong>
                </div>
              </div>
